...
class Home_page_Cubit extends StatefulWidget {
  Home_page_Cubit({Key? key}) : super(key: key);

  @override
  State<Home_page_Cubit> createState() => _Home_pageState();
}

class _Home_pageState extends State<Home_page_Cubit> {
 ...
 //   BlocProvider.of<Products_cubit>(context).fetch_get_Allproducts();
  ...
  _body(Size size){
    return Container(
      child: BlocBuilder<Products_cubit,Products_State>(builder: ( context,  state) {
        final _productController = BlocProvider.of<Products_cubit>(context);
